...
namespace SimpleStack
{
		...
		: Exception
	{
		...
		private void ParseResponseDto()
		{
			...
			map = new Dictionary<string, string>(map, SimpleStack.Extensions.StringExtensions.InvariantComparerIgnoreCase());
			...
			rsMap = new Dictionary<string, string>(rsMap, SimpleStack.Extensions.StringExtensions.InvariantComparerIgnoreCase());
		...
		public ResponseStatus ResponseStatus
		{
			get
			{
				...
				var propertyInfo = PlatformExtensions.GetPropertyInfo(this.ResponseDto.GetType(),"ResponseStatus");
