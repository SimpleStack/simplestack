...
namespace SimpleStack.Tools
{
	...
	public class AssignmentMember
	{
		...
		public PropertySetterDelegate GetSetValueFn()
		{
			...
			if (MethodInfo != null)
				return (PropertySetterDelegate)SimpleStack.Extensions.PlatformExtensions.MakeDelegate(MethodInfo,typeof(PropertySetterDelegate));
	...
	public class AssignmentDefinition
	{
		...
		public void PopulateFromPropertiesWithAttribute(object to, object from, Type attributeType)
		{
			var hasAttributePredicate = (Func<PropertyInfo, bool>)
				(x => SimpleStack.Extensions.PlatformExtensions.CustomAttributes(x,attributeType).Length > 0);
