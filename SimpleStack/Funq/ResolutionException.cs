	...
	public class ResolutionException : Exception
	{
		...
		public ResolutionException(Type missingServiceType)
			: base(String.Format(
				...
				"TODO: ResolutionException Message",//ServiceStack.Properties.Resources.ResolutionException_MissingType, 
		...
		public ResolutionException(Type missingServiceType, string missingServiceName)
			: base(String.Format(
				CultureInfo.CurrentCulture,
				"TODO: ResolutionException Message",//ServiceStack.Properties.Resources.ResolutionException_MissingNamedType,
