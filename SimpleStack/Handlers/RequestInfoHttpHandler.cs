...
using SimpleStack.Serializers.Json;
...
namespace SimpleStack.Handlers
{
	...
	public class RequestInfoHandler : ISimpleStackHttpHandler//, IHttpHandler
	{
		...
		public void ProcessRequest(IHttpRequest httpReq, IHttpResponse httpRes, string operationName)
		{
			...
			response.HandlerFactoryArgs = SimpleStackHttpHandlerFactory.DebugLastHandlerArgs;
