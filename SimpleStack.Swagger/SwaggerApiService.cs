...
{
	[Route(SwaggerResourcesService.ResourcePath + "/{Name*}")]
	[DataContract]
	...
	{
		public static bool UseCamelCaseModelPropertyNames { get; set; }
		public static bool UseLowercaseUnderscoreModelPropertyNames { get; set; }
		public static bool DisableAutoDtoInBodyParam { get; set; }

		private static readonly Regex NicknameCleanerRegex = new Regex(@"[\{\}\*\-_/]*", RegexOptions.Compiled);
